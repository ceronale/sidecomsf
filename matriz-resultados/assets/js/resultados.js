...
function crear_nomina(fecha_act) {
    Swal.fire({
        ...
        width: '700px',
            ...
            <div class="row">
                ...
                <span style="font-size: 12px">Datos del Cargo/Trabajador</span>
                <br></br>
            ...
            <div class="hidden" id="info_cargos_adm">
                <div class="card card-body" style="text-align: left; font-size: 14px">
                    <p>
                        ...
                        Ejemplos: Secretarias, Auxiliares, Asistentes, Analistas, Almacenistas,
                        Supervisores, Jefes, Gerentes, Directores, Vicepresidentes
                        Administrativos y Administrativos de Planta, Industria o Taller..
                    </p>
                </div>
            </div>
            ...
            <div class="hidden" id="info_cargo_puesto">
                <div class="card card-body" style="text-align: left; font-size: 14px">
                    ...
                    Un cargo es una posición formal en una organización con responsabilidades y autoridad específicas.<br><br>
                    Un Puesto se refiere a la ubicación física de un determinado Cargo dentro de la jerarquía y dentro del espacio físico donde se desempeña la persona.
                    </p>
                </div>
            </div>
            ...
            <br>
                      <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" style="text-align: left !important;">
                                    <a
                                         ...
                                         <span style="font-size: 15px;">¿ Es Cargo Critico ? </span></a>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4" style="text-align: right !important;">
                                    <label for="modelo_trabajo">Modelo de Trabajo:</label>
                                </div>
                                <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                            <input type='number' min="0" max="100"' name="porcentaje_presencial" id="porcentaje_presencial" class='form-control'  required autocomplete="on">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                            <input type='number' min="0" max="100" name="porcentaje_remoto" id="porcentaje_remoto" class='form-control'  required autocomplete="on">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    Swal.fire({
        ...
        width: '700px',
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: left !important;">
                <span style="font-size: 12px">Actualizar Registro</span>
                <br></br>
                <span style="font-weight: bold; "font-size: 15px;">IMPORTANTE</span>
                <br>
                <span style="font-size: 14px">Antes de introducir información de los puestos/cargos en la matriz, es necesario que seleccione 
                      ...
                      <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <select class="form-select" aria-label=".form-select-lg example" id="modelo_trabajo" name="modelo_trabajo" onchange="porcentajes(this.value)">
                                <option value="0" > Seleccione... </option>;
                                <option value="R" ${modelo_trabajo === "R" ? "selected" : ""}> Remoto </option>;
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                        <input type='number' min="0" max="100"' value="` + porcentaje_presencial + `" name="porcentaje_presencial" id="porcentaje_presencial" class='form-control'  required autocomplete="on">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                        <input type='number' min="0" max="100" value="` + porcentaje_remoto + `" name="porcentaje_remoto" id="porcentaje_remoto" class='form-control'  required autocomplete="on">
                                        </div>
                                    </div>
                                </div>
                            </div>
